...
def convert_smiles_to_pdb_cactus(smiles_string, output_name="ligand"):
    ...
    try:
        print("Converting SMILES to 3D structure using NCI CACTUS...")
...
def convert_smiles_to_pdb_openbabel(smiles_string, output_name="ligand"):
    ...
    try:
        ...
        print("Converting SMILES to 3D structure using OpenBabel...")
        print(f"SMILES: {smiles_string}")
...
def run_complete_workflow():
    ...
    if n_protein_atoms < 50:
        ...
        print("   This appears to be a small molecule, not a protein structure.")
        print("   Please provide a proper protein PDB file.")
        print("\n   Common issues:")
        print("   - You may have swapped the protein and ligand files")
        print("   - The protein file might be corrupted or incomplete")
        print("   - You might be using a ligand file as the protein input")
        return
    ...
    if is_protein_protein:
        ...
        print("   The standard workflow may be very slow for protein-protein interactions.")
    ...
    # Show configuration
    print("\nConfiguration:")
    print("  Mode: WINDING TRAJECTORY (thread-like motion around protein)")
    ...
    with open(params_file, "w") as f:
        ...
        f.write("\n")
        f.write("Mode: WINDING TRAJECTORY (thread-like motion around protein)\n")
...
def run_dna_generator():
    ...
    print("Double helix will contain:")
    ...
    try:
        ...
        print("  Chains: A (5' to 3'), B (3' to 5')")
...
def save_matryoshka_parameters(
    ...
    with open(param_file, "w") as f:
        ...
        f.write("Mode: Matryoshka (physics-based surface dynamics)\n")
