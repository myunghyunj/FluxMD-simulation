...
class TestEnergyConservation:
    ...
    def test_total_energy_bounded(self):
        ...
        assert (
            max_energy < 10 * mean_energy
        ), f"Energy explosion detected: max={max_energy}, mean={mean_energy}"
...
class TestZeroVolumeHandling:
    ...
    def test_zero_volume_solvation(self):
        ...
        atom1 = AtomContext(
            atom_type="H", coords=np.array([0, 0, 0]), formal_charge=0.0  # Often has zero volume
        )
    ...
    def test_ref15_energy_bounds(self):
        ...
        atom2 = AtomContext(atom_type="N", coords=np.array([1, 0, 0]), formal_charge=-1.0)
...
class TestNumericalStability:
    ...
    def test_force_calculation_stability(self):
        ...
        ligand_sphere = {"radius": 1.0, "mass": 12.0, "center": np.array([0, 0, 0]), "inertia": 2.0}
...
class TestMemoryLeaks:
    ...
    def test_layer_cache_management(self):
        ...
        base_surface = SurfaceMesh(np.random.rand(100, 3) * 10, np.random.randint(0, 100, (200, 3)))
    ...
    def test_trajectory_memory_usage(self):
        ...
        params = {"use_ref15": False, "n_workers": 1, "max_steps": 100}  # Short trajectory
