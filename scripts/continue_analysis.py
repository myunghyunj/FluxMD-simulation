...
def continue_from_iterations(output_dir, protein_file, protein_name="protein"):
    ...
    if os.path.exists(all_flux_file):
        ...
        processed_data['ci_lower'] = processed_data['average_flux'] - 1.96 * processed_data['std_flux']
        processed_data['ci_upper'] = processed_data['average_flux'] + 1.96 * processed_data['std_flux']
