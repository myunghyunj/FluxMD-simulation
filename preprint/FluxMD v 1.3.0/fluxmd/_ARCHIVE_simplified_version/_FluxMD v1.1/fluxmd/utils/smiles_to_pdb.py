...
class SMILESConverter:
    ...
    def _analyze_structure(self, pdb_file: str, sdf_content: str):
        ...
        if multiple_bonds > 0:
            print(f"  Multiple bonds in PDB: {multiple_bonds//2}")  # Divide by 2 as each bond is counted twice
...
def convert_smiles_to_pdb_improved(smiles_string: str, output_name: str = "ligand") -> Optional[str]:
    """
...
def main():
    ...
    parser.add_argument('-o', '--output', default='ligand', 
                       help='Output file base name (default: ligand)')
