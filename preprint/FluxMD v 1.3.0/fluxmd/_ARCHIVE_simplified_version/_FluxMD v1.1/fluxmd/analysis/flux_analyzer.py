...
class TrajectoryFluxAnalyzer:
                    ...
                    try:
                        ...
                        if len(smoothed_tensor) > 1:
                            ...
                            mean_direction = mean_direction / (
                                np.linalg.norm(mean_direction) + 1e-10
                            )
    ...
    def process_trajectory_iterations(self, results_dir, protein_pdb, gpu_trajectory_results=None):
        ...
        df_data = {
            ...
            res_col: res_names,
            chain_col: [
                f"Chain {chain}" for chain in [residue.get_id()[0] for residue in structure[0][0]]
            ],
    ...
    def visualize_trajectory_flux(self, flux_data, protein_name, output_dir):
        ...
        sns.heatmap(flux_matrix, cmap="YlOrRd", cbar_kws={"label": "Flux Value"}, ax=ax2)
