...
class RosettaAtomTyper:
    ...
    def _init_atom_types(self):
        ...
        self.atom_types = {
            # Carbons
            'CAbb': AtomTypeInfo('CAbb', 'C', 'sp2', 1.75, 0.160, -0.24, 3.5, 14.7, False, False, False, True),
            'CObb': AtomTypeInfo('CObb', 'C', 'sp2', 1.75, 0.160, -0.24, 3.5, 14.7, False, False, False, False),
            'CNH2': AtomTypeInfo('CNH2', 'C', 'sp2', 1.75, 0.160, -0.24, 3.5, 14.7, False, False, False, False),
            'COO': AtomTypeInfo('COO', 'C', 'sp2', 1.75, 0.160, -0.24, 3.5, 14.7, False, False, False, False),
            'CH1': AtomTypeInfo('CH1', 'C', 'sp3', 2.00, 0.080, -0.04, 3.5, 23.7, False, False, False, False),
            'CH2': AtomTypeInfo('CH2', 'C', 'sp3', 2.00, 0.080, -0.04, 3.5, 23.7, False, False, False, False),
            'CH3': AtomTypeInfo('CH3', 'C', 'sp3', 2.00, 0.080, 0.00, 3.5, 23.7, False, False, False, False),
            'aroC': AtomTypeInfo('aroC', 'C', 'sp2', 1.75, 0.160, -0.24, 3.5, 18.4, False, False, False, True),
            
            # Nitrogens
            'Nbb': AtomTypeInfo('Nbb', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False),
            'Npro': AtomTypeInfo('Npro', 'N', 'sp2', 1.65, 0.170, -1.55, 2.7, 11.2, False, False, True, False),
            'NH2O': AtomTypeInfo('NH2O', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False),
            'Nlys': AtomTypeInfo('Nlys', 'N', 'sp3', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False, 1.0),
            'Ntrp': AtomTypeInfo('Ntrp', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False),
            'Nhis': AtomTypeInfo('Nhis', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, True, True, True),
            'NtrR': AtomTypeInfo('NtrR', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False, 0.75),
            'Narg': AtomTypeInfo('Narg', 'N', 'sp2', 1.65, 0.170, -3.20, 2.7, 11.2, True, False, True, False, 0.75),
            
            # Oxygens
            'OCbb': AtomTypeInfo('OCbb', 'O', 'sp2', 1.50, 0.210, -2.85, 2.6, 10.8, False, True, True, False),
            'OH': AtomTypeInfo('OH', 'O', 'sp3', 1.55, 0.210, -2.85, 2.6, 10.8, True, True, True, False),
            'OOC': AtomTypeInfo('OOC', 'O', 'sp2', 1.50, 0.210, -2.85, 2.6, 10.8, False, True, True, False, -0.5),
            'ONH2': AtomTypeInfo('ONH2', 'O', 'sp2', 1.50, 0.210, -2.85, 2.6, 10.8, False, True, True, False),
            
            # Sulfurs
            'S': AtomTypeInfo('S', 'S', 'sp3', 1.85, 0.200, -0.45, 3.5, 17.0, False, False, False, False),
            'SH1': AtomTypeInfo('SH1', 'S', 'sp3', 1.85, 0.200, -0.60, 3.5, 17.0, True, False, True, False),
            
            # Hydrogens
            'Hpol': AtomTypeInfo('Hpol', 'H', 's', 1.00, 0.046, 0.00, 1.0, 0.0, True, False, True, False),
            'Hapo': AtomTypeInfo('Hapo', 'H', 's', 1.00, 0.046, 0.00, 1.0, 0.0, False, False, False, False),
            'Haro': AtomTypeInfo('Haro', 'H', 's', 1.10, 0.015, 0.00, 1.0, 0.0, False, False, False, True),
            'HNbb': AtomTypeInfo('HNbb', 'H', 's', 0.95, 0.046, 0.00, 1.0, 0.0, True, False, True, False),
            'HS': AtomTypeInfo('HS', 'H', 's', 0.95, 0.046, 0.00, 1.0, 0.0, True, False, True, False),
            
            # Special
            'VIRT': AtomTypeInfo('VIRT', 'X', 'none', 1.00, 0.000, 0.00, 1.0, 0.0, False, False, False, False),
        }
    ...
    def _init_residue_specific_rules(self):
        ...
        self.residue_rules = {
            # Amino acids
            'ALA': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH3', 'H': 'HNbb', 'HA': 'Hapo'
            },
            'ARG': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'CD': 'CH2', 'NE': 'NtrR',
                'CZ': 'CNH2', 'NH1': 'Narg', 'NH2': 'Narg',
                'H': 'HNbb', 'HE': 'Hpol', 'HH11': 'Hpol', 'HH12': 'Hpol',
                'HH21': 'Hpol', 'HH22': 'Hpol'
            },
            'ASN': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CNH2', 'OD1': 'ONH2', 'ND2': 'NH2O',
                'H': 'HNbb', 'HD21': 'Hpol', 'HD22': 'Hpol'
            },
            'ASP': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
            ...
            'CYS': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'SG': 'SH1', 'H': 'HNbb', 'HG': 'HS'
            },
            'GLN': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'CD': 'CNH2', 'OE1': 'ONH2',
                'NE2': 'NH2O', 'H': 'HNbb', 'HE21': 'Hpol', 'HE22': 'Hpol'
            },
            'GLU': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'CD': 'COO', 'OE1': 'OOC',
                'OE2': 'OOC', 'H': 'HNbb'
            },
            'GLY': {
                'N': 'Nbb', 'CA': 'CH2', 'C': 'CObb', 'O': 'OCbb',
                'H': 'HNbb'
            },
            'HIS': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'aroC', 'ND1': 'Nhis', 'CD2': 'aroC',
                'CE1': 'aroC', 'NE2': 'Nhis', 'H': 'HNbb',
                'HD1': 'Hpol', 'HE2': 'Hpol'
            },
            'ILE': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH1', 'CG1': 'CH2', 'CG2': 'CH3', 'CD1': 'CH3',
                'H': 'HNbb'
            },
            'LEU': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
            ...
            'LYS': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'CD': 'CH2', 'CE': 'CH2',
                'NZ': 'Nlys', 'H': 'HNbb', 'HZ1': 'Hpol', 'HZ2': 'Hpol',
                'HZ3': 'Hpol'
            },
            'MET': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'SD': 'S', 'CE': 'CH3',
                'H': 'HNbb'
            },
            'PHE': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CAbb', 'CD1': 'CAbb', 'CD2': 'CAbb',
                'CE1': 'CAbb', 'CE2': 'CAbb', 'CZ': 'CAbb',
                'H': 'HNbb', 'HD1': 'Haro', 'HD2': 'Haro',
                'HE1': 'Haro', 'HE2': 'Haro', 'HZ': 'Haro'
            },
            'PRO': {
                'N': 'Npro', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CH2', 'CD': 'CH2'
            },
            'SER': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'OG': 'OH', 'H': 'HNbb', 'HG': 'Hpol'
            },
            'THR': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH1', 'OG1': 'OH', 'CG2': 'CH3',
                'H': 'HNbb', 'HG1': 'Hpol'
            },
            'TRP': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CAbb', 'CD1': 'CAbb', 'CD2': 'aroC',
                'NE1': 'Ntrp', 'CE2': 'aroC', 'CE3': 'CAbb', 'CZ2': 'CAbb',
                'CZ3': 'CAbb', 'CH2': 'CAbb', 'H': 'HNbb',
                'HE1': 'Hpol', 'HD1': 'Haro', 'HE3': 'Haro',
                'HZ2': 'Haro', 'HZ3': 'Haro', 'HH2': 'Haro'
            },
            'TYR': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
                'CB': 'CH2', 'CG': 'CAbb', 'CD1': 'CAbb', 'CD2': 'CAbb',
                'CE1': 'CAbb', 'CE2': 'CAbb', 'CZ': 'CAbb', 'OH': 'OH',
                'H': 'HNbb', 'HH': 'Hpol', 'HD1': 'Haro', 'HD2': 'Haro',
                'HE1': 'Haro', 'HE2': 'Haro'
            },
            'VAL': {
                'N': 'Nbb', 'CA': 'CH1', 'C': 'CObb', 'O': 'OCbb',
    ...
    def _init_connectivity_patterns(self):
        ...
        self.connectivity_patterns = {
            ...
            'sp2_carbon': {
                'bond_count': [3],
                'neighbor_elements': {'C', 'N', 'O', 'S'}
            },
            'sp3_carbon': {
                'bond_count': [4],
                'neighbor_elements': {'C', 'N', 'O', 'S', 'H'}
            },
            'aromatic': {
                'ring_size': [5, 6],
                'planar': True
